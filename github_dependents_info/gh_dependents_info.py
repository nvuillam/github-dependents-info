    ...
    def build_markdown(self, **options) -> str:
        ...
        for dep_repo in self.dependent_repos:
            ...
            if len(dep_repo["public_dependents"]) == 0:
                ...
                md_lines += [
                    "Total: " + str(dep_repo["total_dependents_number"]),
                    "Public: " + str(dep_repo["public_dependents_number"]),
                    "Private: " + str(dep_repo["private_dependents_number"]),
                    "",
                ]
                for repo1 in dep_repo["public_dependents"]:
                    md_lines += ["  - " + repo1]
            md_lines += [""]
        md_lines += ["_ Generated by [github-dependents-info](https://github.com/nvuillam/github-dependents-info)_"]
        md_lines_str = "\n".join(md_lines)
